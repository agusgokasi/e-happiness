  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/prov" enctype="multipart/form-data" method="post" id="myForm">
          {{ csrf_field() }}
        <div class="form-group row">
            <label for="provinsi" class="col-md-4 col-form-label text-md-right">{{ __('Province Name') }}</label>

            <div class="col-md-6">
                <textarea name="provinsi" style="font-size: 15px" class="form-control{{ $errors->has('provinsi') ? ' is-invalid' : '' }}" placeholder="Masukkan provinsi" id="provinsi" value="{{ old('provinsi') }}" required></textarea>
