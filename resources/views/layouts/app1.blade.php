...
<head>
    ...
    <link src="{{ asset('sb/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
    <link src="{{ asset('sb/vendor/fontawsome-free/cdd/all.min.css') }}" rel="stylesheet" type= "text/css">
    <link src="{{ asset('sb/vendor/datatables/dataTables.bootstrap4.css') }}" rel="stylesheet">
    <link src="{{ asset('sb/css/sn-admin.css') }}" rel="stylesheet">
